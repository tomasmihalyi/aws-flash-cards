## Tier B draft for AC-19 — Regions & compliance
...
```bash
node tools/sign-off.ts --by "<your name>" --card AC-19
```

Model: `au.anthropic.claude-sonnet-4-5-20250929-v1:0` · drafted 2026-08-11T05:00:58.620Z · re-gated at apply time
